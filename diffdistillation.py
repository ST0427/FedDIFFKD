...
from models import DiffusionModel, NoiseAdapter, AutoEncoder, DDIMPipeline
from scheduling_ddim import DDIMScheduler


class DiffDistillation(nn.Module):
    def  __init__(
            self,
            student_channels,
            teacher_channels,
    ...
    def forward(self, student_feat, teacher_feat):
        ...
        return refined_feat, ddim_loss,G
